describe('Cypress WebTable Tests', {baseUrl: 'http://demoqa.com'}, () => {
    /**
    ...
    it('Check finding and editing a record', () => {
         ...
         * 1.get me table body
         * 2.get me the row that contain Alden
        ...
        .then((row) => {
            ...
            cy.get('#submit').click();
            // from cypress test perspective we are still inside row element: need to the ASSERTION
